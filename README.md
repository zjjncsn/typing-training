...
- **中文文章练习**：提供格言、散文、诗歌、小说、笑话和杂项等 6 类共 180 篇文章，支持输入法预编辑提示与独立进度。
...
pnpm content:chinese-articles # 重新生成中文文章数据
```
...
public/data/chinese/articles/   # 180 篇按需加载的中文文章
scripts/                        # 课程与词典数据生成脚本
tools/                          # 原始词典格式分析和提取工具
docs/                           # 原版窗体与词典格式研究记录
```
...
| 中文文章练习         | `/practice/chinese/articles/:articleId?`     |
